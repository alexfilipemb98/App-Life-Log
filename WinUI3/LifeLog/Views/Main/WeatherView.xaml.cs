...
{
    // Modelo para os cartões de 5 dias
    public class DailyForecast
    {
        public string DayName { get; set; }
        public string IconGlyph { get; set; }
        public string MaxTempStr { get; set; }
        public string MinTempStr { get; set; }
    }
    ...
    public sealed partial class WeatherView : UserControl
    {
        ...
        public ObservableCollection<DailyForecast> FiveDayForecast { get; set; } = new ObservableCollection<DailyForecast>();
        ...
        private void Update5DayForecast(JsonNode data, int timezoneOffsetSeconds)
        {
            ...
            foreach (var group in dailyGroups)
            {
                ...
                FiveDayForecast.Add(new DailyForecast
                {
