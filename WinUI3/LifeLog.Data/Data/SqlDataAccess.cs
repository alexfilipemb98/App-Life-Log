...
public class SqlDataAccess : IDisposable
{
    ...
    public async Task<BatchResultItem> RunBatchAsync(string sql, bool returnsRows, CancellationToken ct, int? commandTimeout = null)
    {
        if (string.IsNullOrWhiteSpace(sql))
            return new BatchResultItem { ReturnsRows = returnsRows };
