namespace LifeLog.UI.Common.Forms.Dialog
{
    partial class MessageBoxDialogForm
    {
        ...
        private void InitializeComponent()
        {
			...
			// sbNo
			// 
			this.sbNo.Appearance.BackColor = DevExpress.LookAndFeel.DXSkinColors.FillColors.Danger;
			...
			this.sbNo.Appearance.Options.UseBackColor = true;
			...
			// sbYes
			// 
			this.sbYes.Appearance.BackColor = DevExpress.LookAndFeel.DXSkinColors.FillColors.Success;
			this.sbYes.Appearance.Font = new System.Drawing.Font("Tahoma", 10.75F, System.Drawing.FontStyle.Bold);
			this.sbYes.Appearance.Options.UseBackColor = true;
