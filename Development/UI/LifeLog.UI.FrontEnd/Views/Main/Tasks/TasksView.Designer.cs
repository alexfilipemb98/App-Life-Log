namespace LifeLog.UI.FrontEnd.Views.Main.Tasks
{
	partial class TasksView
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.tasksModelBindingSource.DataSource = typeof(LifeLog.Data.Models.TasksModel);
			// 
			// gvTasks
			// 
			...
			this.bbiSave.Id = 3;
			this.bbiSave.ImageOptions.SvgImage = global::LifeLog.Base.Assets.Resources.save;
