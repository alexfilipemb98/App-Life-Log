...
namespace Life_Log_App.Forms
{
	...
	public partial class MainForm : RibbonForm
	{
		...
		private void LoadModuleSettings()
		{
			...
			rpEntertainment.RibbonPageVisibly();
			...
			rpTools.RibbonPageVisibly();

			//Tables
			bbiTablesImagesView.HideShowBarButton(AppContext.ModuleSettings.EnableTableImages);
			bbiTablesImagesView.HideShowBarButton(AppContext.ModuleSettings.EnableTableImages);
			rpTables.RibbonPageVisibly();
		}
		...
		private void OpenPages(ItemClickEventArgs e, string userControl)
		{
			try
			{
				...
				object obj = ControlsHelper.CreateInstanceFromName(userControl, "Life_Log_App.Views.");
