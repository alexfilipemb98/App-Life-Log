...
namespace Life_Log_App.Helpers
{
	...
	internal static class AppHelper
	{
		...
		internal static void StatusMessage(string message, Color color, bool showDialog = false)
		{
		...
		internal static void StatusMessage(string message, bool saved, bool showDialog = false) =>
