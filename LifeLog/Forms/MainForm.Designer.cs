...
partial class MainForm
{
	...
	private void InitializeComponent()
	{
		...
		bbiJsonApi = new LifeLog.Components.BarButtonItemEx();
		...
		// bbiJsonApi
		// 
		bbiJsonApi.Caption = "Json Api";
		bbiJsonApi.Id = 37;
		bbiJsonApi.ImageOptions.SvgImage = (DevExpress.Utils.Svg.SvgImage)resources.GetObject("bbiJsonApi.ImageOptions.SvgImage");
		bbiJsonApi.Name = "bbiJsonApi";
		bbiJsonApi.TargetViewTypeName = "LifeLog.Views.JsonApi.JsonApiView";
		// 
		// ribbonPage1
		// 
		...
		ribbonPageGroup2.ItemLinks.Add(bbiJsonApi);
    ...
    private LifeLog.Components.BarButtonItemEx bbiJsonApi;
}