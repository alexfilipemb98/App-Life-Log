	...
	public partial class CoinFlipGameView : XtraUserControl
	{
		...
		private async void bbiFlipCoin_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
		{
			try
			{
				...
				peCoinGame.SvgImage = turn == Coin.Heads ? Properties.Resources.coin_heads :Properties.Resources.coin_tails;
				...
				for (int i = 0; i < timesToPlay; i++)
				{
					...
					if (i == timesToPlay - 1)
					{
						...
						if (final == turn)
						{
							peCoinGame.SvgImage = turn == Coin.Heads ?Properties.Resources.coin_tails :Properties.Resources.coin_heads;
							await Task.Delay(250);
						}

						scores[final]++;
						peCoinGame.SvgImage = final == Coin.Heads ?Properties.Resources.coin_heads :Properties.Resources.coin_tails;
						UpdateSocreBoard();
					}
					else
					{
