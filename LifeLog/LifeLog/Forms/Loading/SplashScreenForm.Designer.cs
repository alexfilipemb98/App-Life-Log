namespace LifeLog.UI.Common.Forms.Loading
{
    partial class SplashScreenForm
    {
		...
		private void InitializeComponent()
		{
			...
			labelCopyright.Location = new Point(12, 268);
			labelCopyright.Name = "labelCopyright";
			labelCopyright.Size = new Size(140, 19);
			...
			labelVersion.Location = new Point(348, 268);
			labelVersion.Name = "labelVersion";
			labelVersion.Size = new Size(140, 19);
			...
			progressPanel.BackgroundImage = LifeLog.Properties.Resources.SplashScreen;
			...
			progressPanel.Size = new Size(500, 299);
