namespace LifeLog.UI.Common.Forms.Auth
{
	partial class AuthForm
	{
		...
		private void InitializeComponent()
		{
			...
			ribbon.EmptyAreaImageOptions.ImagePadding = new Padding(29, 28, 29, 28);
			ribbon.ExpandCollapseItem.Id = 0;
			ribbon.Items.AddRange(new DevExpress.XtraBars.BarItem[] { bbiDatabaseSettings, ribbon.ExpandCollapseItem, bbiGoBack, bsiDatabase, bsiAppVersion });
			...
			ribbonStatusBar.Size = new Size(658, 39);
			// 
			// layoutControl
			// 
			...
			teEmail.Location = new Point(44, 90);
			...
			teUsername.Location = new Point(44, 38);
			...
			bePassword.Location = new Point(44, 142);
			...
			layoutControlGroup2.Location = new Point(0, 35);
			...
			navigationFrame.Location = new Point(0, 49);
			navigationFrame.Margin = new Padding(4, 2, 4, 2);
