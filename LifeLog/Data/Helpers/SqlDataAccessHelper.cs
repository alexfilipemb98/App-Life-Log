...
namespace Data.Helpers
{
	...
	/// </summary>
	public class SqlDataAccessHelper : IDisposable
	{
		#region MAIN
		...
		public SqlDataAccessHelper(string stringConn, bool startConnection = true)
		{
		...
		public SqlDataAccessHelper(IDbConnection dbConnection)
		{
			if (_connection == null)
			{
