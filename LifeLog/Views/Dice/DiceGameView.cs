...
namespace LifeLog.Views.Dice
{
	...
	public partial class DiceGameView : XtraUserControl
	{
		...
		private SvgImage? GetImage(Dice dice)
		{
			...
			{
				case Dice.One:
					img = Properties.Resources.dice_1;
					break;
				case Dice.Two:
					img = Properties.Resources.dice_2;
					break;
				case Dice.Three:
					img = Properties.Resources.dice_3;
					break;
				case Dice.Four:
					img = Properties.Resources.dice_4;
					break;
				case Dice.Five:
					img = Properties.Resources.dice_5;
					break;
				case Dice.Six:
					img = Properties.Resources.dice_6;
					break;
			}
