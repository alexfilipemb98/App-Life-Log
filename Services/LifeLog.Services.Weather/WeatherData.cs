...
public sealed class WeatherData
{
    ...
    private static void TryAttachIcon(WeatherRootObjectModel? weatherData)
    {
        ...
        weatherData.Weather.First().Image =
            ImagesUtil.ImageUrlToBitmap($"https://openweathermap.org/img/wn/{icon}@2x.png");
    }
